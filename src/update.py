...
class EdgeServer():
    def _init_(self,args,index_edge,model,clients_weights):
        self.args = args
        self.index_edge = index_edge
        self.model = model
        self.clients_weights = clients_weights
    def avg_clients(self):
        self.model = average_weights(self.clients_weights) 
...
def test_inference(args, model, test_dataset):
    ...
    for batch_idx, (images, labels) in enumerate(testloader):
        ...
        #print("predict labels",pred_labels)
